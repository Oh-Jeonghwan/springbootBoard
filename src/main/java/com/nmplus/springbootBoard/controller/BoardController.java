...
public class BoardController {
	...
	public String list(Model model
		...
		Page<Board> boards = boardService.selectList(pageable, condition, keyword); //PageRequest.of(시작 인덱스 0, 보여줄 사이즈 20)
		...
		//전체 페이지 수와 현재 페이지 + 10 중 작은 것 반환(전체 페이지가 11일 경우 현재 페이지가 2를 넘어가면 전체 페이지 수(11) 반환 )
